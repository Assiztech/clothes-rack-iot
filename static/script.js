async function fetchTemperature() {
    const response = await fetch("http://192.168.170.197:8000/status", {
        method: "GET",
    });
...
async function forceCollect() {
    try {
        const response = await fetch("http://192.168.170.197:8000/force-collect", {
            method: "GET",
        });
        if (response.ok) {
...
async function autoManual() {
    try {
        const response = await fetch("http://192.168.170.197:8000/auto-manual", {
            method: "GET",
        });
        if (response.ok) {
            alert("Action executed successfully");
